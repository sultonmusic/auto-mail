  ...
  var DICT = {
    uz: {
      ...
      ui: {
        ...
        'banner.signedOut': 'Gmail bilan aloqa uzildi.',
        'banner.signIn': 'Kirish',
        ...
        'toast.scriptHandles': 'Javobni Apps Script beryapti (Gmail\'dagi AutoReplied yorlig\'i shundan darak). Ilova javob yozmaydi — takrorlanmasligi uchun.',
    ...
    en: {
      ...
      ui: {
        ...
        'banner.signedOut': 'The Gmail connection dropped.',
        ...
        'toast.scriptHandles': 'Apps Script is answering (the AutoReplied label shows it). The app stays out of the way so nobody gets two replies.',
    ...
    ru: {
      ...
      ui: {
        ...
        'banner.signedOut': 'Связь с Gmail прервалась.',
        'banner.signIn': 'Войти',
        ...
        'toast.scriptHandles': 'Отвечает Apps Script (об этом говорит ярлык AutoReplied). Приложение не отвечает, чтобы не было дубля.',
      ...
      card: {
        ...
        defaultTitle: 'Ваше обращение получено',
        defaultText: 'Спасибо за письмо! Я, Juraev Sulton, ознакомлюсь с обращением и отвечу на этот адрес в ближайшее время.',
        defaultSteps: 'Я изучу детали вашего обращения.\nЕсли что-то нужно уточнить, свяжусь с вами.\nОтвет придёт на этот адрес отдельным письмом.',
